...
window = tk.Tk()
window.title("Attandance System- Admin Console")
...
message = tk.Label(window, text="Employee Attandance System ", bg="Black", fg="White", width=50,
...
takeImg = tk.Button(window, text="Capture Image",command=take_img,fg="Red", bg="Black"  ,width=20  ,height=3, activebackground = "Pink" ,font=('times', 20, 'italic bold '))
takeImg.place(x=200, y=500)

trainImg = tk.Button(window, text="Train Model",fg="Red",command=trainimg ,bg="Black"  ,width=20  ,height=3, activebackground = "Pink",font=('times', 20, 'italic bold '))
